...
(function (nerdbox) {
    ...
    nerdbox.scaleElementsByFactor = scaleElementsByFactor;
    ...
    nerdbox.inverseRealFourierTransform = inverseRealFourierTransform;
})(nerdbox || (nerdbox = {}));
var nerdbox;
(function (nerdbox) {
    var Config = (function () {
        ...
        Config.getDrumWave = function (index) {
            ...
            if (wave == null) {
                ...
                if (index == 0) {
                    ...
                    nerdbox.inverseRealFourierTransform(wave);
                    nerdbox.scaleElementsByFactor(wave, 1.0 / Math.sqrt(wave.length));
                }
                else {
    ...
    Config.drumNoteColorsBright = ["#a6b2b1", "#a396a1", "#afaea3"];
    Config.midiPitchChannelNames = ["green channel", "cyan channel", "blue channel", "purple channel", "magenta channel", "red channel", "orange channel", "yellow channel", "sea foam channel"];
    Config.midiDrumChannelNames = ["drum channel one", "drum channel two", "drum channel three"];
    ...
    nerdbox.makeNotePin = makeNotePin;
    ...
    var Synth = (function () {
        function Synth(song) {
            ...
            this.paused = true;
            this.channelPhaseA = [0.0, 0.0, 0.0, 0.0];
            this.channelPhaseB = [0.0, 0.0, 0.0, 0.0];
...
(function (nerdbox) {
    ...
    nerdbox.ChangeNotifier = ChangeNotifier;
})(nerdbox || (nerdbox = {}));
var nerdbox;
(function (nerdbox) {
    var SongDocument = (function () {
        function SongDocument(string) {
            var _this = this;
            this.history = this;
            this.notifier = new nerdbox.ChangeNotifier();
            this.channel = 0;
            this.bar = 0;
            this.volume = 75;
            ...
            this._whenHistoryStateChanged = function () {
                ...
                if (state == null) {
                    ...
                    new nerdbox.ChangeSong(_this, location.hash);
            ...
            this.song = new nerdbox.Song(string);
            this.synth = new nerdbox.Synth(this.song);
    ...
    nerdbox.SongDocument = SongDocument;
})(nerdbox || (nerdbox = {}));
var nerdbox;
(function (nerdbox) {
    var html;
    (function (html) {
        ...
        html.text = text;
    })(html = nerdbox.html || (nerdbox.html = {}));
...
(function (nerdbox) {
    ...
    nerdbox.UndoableChange = UndoableChange;
    ...
    nerdbox.ChangeGroup = ChangeGroup;
    ...
    nerdbox.ChangeSequence = ChangeSequence;
})(nerdbox || (nerdbox = {}));
var nerdbox;
(function (nerdbox) {
    var ChangePins = (function (_super) {
        ...
        return ChangePins;
    }(nerdbox.UndoableChange));
    nerdbox.ChangePins = ChangePins;
    var ChangeEnvelope = (function (_super) {
        __extends(ChangeEnvelope, _super);
        function ChangeEnvelope(doc, newValue) {
            var _this = _super.call(this) || this;
            var oldValue = doc.song.instrumentEnvelopes[doc.channel][doc.getCurrentInstrument()];
    ...
    nerdbox.ChangePattern = ChangePattern;
    ...
    nerdbox.ChangeBarCount = ChangeBarCount;
                ...
                for (var i = 0; i < newPitchChannelCount; i++) {
                    ...
                    if (i < doc.song.pitchChannelCount) {
                        ...
                        for (var j = 0; j < doc.song.patternsPerChannel; j++)
                            channelPatterns[channel][j] = new nerdbox.Pattern();
    ...
    nerdbox.ChangeChannelCount = ChangeChannelCount;
    var ChangeBeatsPerBar = (function (_super) {
        ...
        function ChangeBeatsPerBar(doc, newValue) {
            ...
            if (doc.song.beatsPerBar != newValue) {
                if (doc.song.beatsPerBar > newValue) {
                    var sequence = new nerdbox.ChangeSequence();
                    for (var i = 0; i < doc.song.getChannelCount(); i++) {
                        for (var j = 0; j < doc.song.channelPatterns[i].length; j++) {
    ...
    nerdbox.ChangeBeatsPerBar = ChangeBeatsPerBar;
    ...
    nerdbox.ChangeChannelBar = ChangeChannelBar;
    var ChangeChorus = (function (_super) {
        __extends(ChangeChorus, _super);
        function ChangeChorus(doc, newValue) {
            var _this = _super.call(this) || this;
            var oldValue = doc.song.instrumentChorus[doc.channel][doc.getCurrentInstrument()];
            if (oldValue != newValue) {
                _this._didSomething();
    ...
    nerdbox.ChangeChorus = ChangeChorus;
    var ChangeEffect = (function (_super) {
        __extends(ChangeEffect, _super);
        function ChangeEffect(doc, newValue) {
            var _this = _super.call(this) || this;
            var oldValue = doc.song.instrumentEffects[doc.channel][doc.getCurrentInstrument()];
            if (oldValue != newValue) {
    ...
    nerdbox.ChangeEffect = ChangeEffect;
    var ChangeFilter = (function (_super) {
        __extends(ChangeFilter, _super);
        function ChangeFilter(doc, newValue) {
            var _this = _super.call(this) || this;
            var oldValue = doc.song.instrumentFilters[doc.channel][doc.getCurrentInstrument()];
            if (oldValue != newValue) {
    ...
    nerdbox.ChangeFilter = ChangeFilter;
    var ChangeInstrumentsPerChannel = (function (_super) {
        __extends(ChangeInstrumentsPerChannel, _super);
        function ChangeInstrumentsPerChannel(doc, instrumentsPerChannel) {
            var _this = _super.call(this) || this;
            var oldInstrumentsPerChannel = doc.song.instrumentsPerChannel;
            var newInstrumentsPerChannel = instrumentsPerChannel;
            if (doc.song.instrumentsPerChannel != newInstrumentsPerChannel) {
                var oldInstrumentWaves = doc.song.instrumentWaves;
                var oldInstrumentFilters = doc.song.instrumentFilters;
                var oldInstrumentEnvelopes = doc.song.instrumentEnvelopes;
                var oldInstrumentEffects = doc.song.instrumentEffects;
                var oldInstrumentChorus = doc.song.instrumentChorus;
                var oldInstrumentVolumes = doc.song.instrumentVolumes;
                ...
                for (var i = 0; i < doc.song.getChannelCount(); i++) {
                    ...
                    var newIndices = [];
                    for (var j = 0; j < doc.song.patternsPerChannel; j++) {
                        var oldIndex = doc.song.channelPatterns[i][j].instrument;
    ...
    nerdbox.ChangeInstrumentsPerChannel = ChangeInstrumentsPerChannel;
    ...
    nerdbox.ChangeLoop = ChangeLoop;
    var ChangePitchAdded = (function (_super) {
        __extends(ChangePitchAdded, _super);
        function ChangePitchAdded(doc, pattern, note, pitch, index, deletion) {
    ...
    nerdbox.ChangePitchAdded = ChangePitchAdded;
    ...
    nerdbox.ChangeOctave = ChangeOctave;
    var ChangePartsPerBeat = (function (_super) {
        ...
        function ChangePartsPerBeat(doc, newValue) {
            ...
            if (doc.song.partsPerBeat != newValue) {
                for (var i = 0; i < doc.song.getChannelCount(); i++) {
                    for (var j = 0; j < doc.song.channelPatterns[i].length; j++) {
                        _this.append(new ChangeRhythm(doc, doc.song.channelPatterns[i][j], doc.song.partsPerBeat, newValue));
                    }
                }
    ...
    nerdbox.ChangePartsPerBeat = ChangePartsPerBeat;
    ...
    nerdbox.ChangePaste = ChangePaste;
    ...
    nerdbox.ChangePatternInstrument = ChangePatternInstrument;
    var ChangePatternsPerChannel = (function (_super) {
        ...
        function ChangePatternsPerChannel(doc, newValue) {
            ...
            if (doc.song.patternsPerChannel != newValue) {
                for (var i = 0; i < doc.song.getChannelCount(); i++) {
                    var channelBars = doc.song.channelBars[i];
                    var channelPatterns = doc.song.channelPatterns[i];
                    for (var j = 0; j < channelBars.length; j++) {
                        if (channelBars[j] > newValue)
                            channelBars[j] = 0;
                    }
                    for (var j = channelPatterns.length; j < newValue; j++) {
                        channelPatterns[j] = new nerdbox.Pattern();
                    }
    ...
    nerdbox.ChangePatternsPerChannel = ChangePatternsPerChannel;
    var ChangePinTime = (function (_super) {
        ...
        function ChangePinTime(doc, note, pinIndex, shiftedTime) {
            ...
            for (var i = 0; i < _this._oldPins.length; i++) {
                ...
                if (time < skipStart) {
                    _this._newPins.push(nerdbox.makeNotePin(oldPin.interval, time, oldPin.volume));
                }
                else if (time > skipEnd) {
                    if (!setPin) {
                        _this._newPins.push(nerdbox.makeNotePin(_this._oldPins[pinIndex].interval, shiftedTime, _this._oldPins[pinIndex].volume));
                        setPin = true;
                    }
                    _this._newPins.push(nerdbox.makeNotePin(oldPin.interval, time, oldPin.volume));
                }
    ...
    nerdbox.ChangePinTime = ChangePinTime;
            ...
            for (; i != stop; i += direction) {
                ...
                for (;;) {
                    if (!setStart) {
                        ...
                        if (time * direction < bendStart * direction) {
                            push(nerdbox.makeNotePin(oldPin.interval, time, oldPin.volume));
                            break;
                        }
                        else {
                            push(nerdbox.makeNotePin(prevInterval, bendStart, prevVolume));
                            setStart = true;
                        }
                    }
                    else if (!setEnd) {
                        ...
                        if (time * direction < bendEnd * direction) {
                            ...
                            push(nerdbox.makeNotePin(bendTo, bendEnd, prevVolume));
                            setEnd = true;
                        }
                    }
                    else {
                        if (time * direction == bendEnd * direction) {
                            ...
                            if (oldPin.interval != prevInterval)
                                persist = false;
                            push(nerdbox.makeNotePin(persist ? bendTo : oldPin.interval, time, oldPin.volume));
                            break;
                        }
                    }
                }
    ...
    nerdbox.ChangePitchBend = ChangePitchBend;
    var ChangeRhythm = (function (_super) {
        ...
        return ChangeRhythm;
    }(nerdbox.ChangeSequence));
    nerdbox.ChangeRhythm = ChangeRhythm;
    var ChangeRhythmNote = (function (_super) {
        ...
        function ChangeRhythmNote(doc, note, changeRhythm) {
            ...
            for (var _i = 0, _a = _this._oldPins; _i < _a.length; _i++) {
                var oldPin = _a[_i];
                _this._newPins.push(nerdbox.makeNotePin(oldPin.interval, changeRhythm(oldPin.time + _this._oldStart) - _this._oldStart, oldPin.volume));
            }
            _this._finishSetup();
            return _this;
        }
    ...
    nerdbox.ChangeRhythmNote = ChangeRhythmNote;
    ...
    nerdbox.ChangeScale = ChangeScale;
    ...
    nerdbox.ChangeTempo = ChangeTempo;
    ...
    nerdbox.ChangeReverb = ChangeReverb;
    ...
    nerdbox.ChangeNoteAdded = ChangeNoteAdded;
    var ChangeNoteLength = (function (_super) {
        ...
        function ChangeNoteLength(doc, note, truncStart, truncEnd) {
            ...
            for (i = 0; i < _this._oldPins.length; i++) {
                ...
                if (oldPin.time < truncStart) {
                    ...
                    if (oldPin.time > truncStart && !setStart) {
                        _this._newPins.push(nerdbox.makeNotePin(prevInterval, truncStart, prevVolume));
                    }
                    _this._newPins.push(nerdbox.makeNotePin(oldPin.interval, oldPin.time, oldPin.volume));
                    setStart = true;
            ...
            if (pushLastPin)
                _this._newPins.push(nerdbox.makeNotePin(_this._oldPins[i].interval, truncEnd, _this._oldPins[i].volume));
            _this._finishSetup();
            return _this;
        }
        return ChangeNoteLength;
    }(ChangePins));
    nerdbox.ChangeNoteLength = ChangeNoteLength;
    var ChangeNoteTruncate = (function (_super) {
        __extends(ChangeNoteTruncate, _super);
        function ChangeNoteTruncate(doc, bar, start, end, skipNote) {
            var _this = _super.call(this) || this;
            var i = 0;
            while (i < bar.notes.length) {
                var note = bar.notes[i];
    ...
    nerdbox.ChangeNoteTruncate = ChangeNoteTruncate;
    var ChangeTransposeNote = (function (_super) {
        ...
        function ChangeTransposeNote(doc, note, upward) {
            ...
            _this._newPitches = [];
            var maxPitch = (doc.song.getChannelIsDrum(doc.channel) ? nerdbox.Config.drumCount - 1 : nerdbox.Config.maxPitch);
            for (var i = 0; i < _this._oldPitches.length; i++) {
                var pitch = _this._oldPitches[i];
                if (upward) {
                    for (var j = pitch + 1; j <= maxPitch; j++) {
                        if (doc.song.getChannelIsDrum(doc.channel) || nerdbox.Config.scaleFlags[doc.song.scale][j % 12]) {
                            pitch = j;
                            break;
                        }
                    }
            ...
            for (var _i = 0, _a = _this._oldPins; _i < _a.length; _i++) {
                ...
                if (upward) {
                    for (var i = interval + 1; i <= max; i++) {
                        if (doc.song.getChannelIsDrum(doc.channel) || nerdbox.Config.scaleFlags[doc.song.scale][i % 12]) {
                            interval = i;
                            break;
                        }
                    }
                ...
                _this._newPins.push(nerdbox.makeNotePin(interval, oldPin.time, oldPin.volume));
            }
    ...
    nerdbox.ChangeTransposeNote = ChangeTransposeNote;
    var ChangeTranspose = (function (_super) {
        __extends(ChangeTranspose, _super);
        function ChangeTranspose(doc, bar, upward) {
            var _this = _super.call(this) || this;
            for (var i = 0; i < bar.notes.length; i++) {
                _this.append(new ChangeTransposeNote(doc, bar.notes[i], upward));
            }
            return _this;
        }
        return ChangeTranspose;
    }(nerdbox.ChangeSequence));
    nerdbox.ChangeTranspose = ChangeTranspose;
    ...
    nerdbox.ChangeVolume = ChangeVolume;
        ...
        function ChangeVolumeBend(doc, note, bendPart, bendVolume, bendInterval) {
            ...
            for (var _i = 0, _a = note.pins; _i < _a.length; _i++) {
                ...
                if (pin.time < bendPart) {
                    ...
                    _this._newPins.push(nerdbox.makeNotePin(bendInterval, bendPart, bendVolume));
                    inserted = true;
                }
                else {
                    if (!inserted) {
    ...
    nerdbox.ChangeVolumeBend = ChangeVolumeBend;
...
(function (nerdbox) {
    ...
    var PatternEditor = (function () {
        function PatternEditor(_doc) {
            var _this = this;
            this._doc = _doc;
            this._svgNoteBackground = nerdbox.svgElement("pattern", { id: "patternEditorNoteBackground", x: "0", y: "0", width: "64", height: "156", patternUnits: "userSpaceOnUse" });
            this._svgDrumBackground = nerdbox.svgElement("pattern", { id: "patternEditorDrumBackground", x: "0", y: "0", width: "64", height: "40", patternUnits: "userSpaceOnUse" });
            this._svgBackground = nerdbox.svgElement("rect", { x: "0", y: "0", width: "512", height: "481", "pointer-events": "none", fill: "url(#patternEditorNoteBackground)" });
            this._svgNoteContainer = nerdbox.svgElement("svg");
            this._svgPlayhead = nerdbox.svgElement("rect", { id: "", x: "0", y: "0", width: "4", height: "481", fill: "white", "pointer-events": "none" });
            this._svgPreview = nerdbox.svgElement("path", { fill: "none", stroke: "white", "stroke-width": "2", "pointer-events": "none" });
            this._svg = nerdbox.svgElement("svg", { style: "background-color: #000000; touch-action: none; position: absolute;", width: "100%", height: "100%", viewBox: "0 0 512 481", preserveAspectRatio: "none" }, [
                nerdbox.svgElement("defs", undefined, [
            ...
            this.container = nerdbox.html.div({ style: "height: 100%; overflow:hidden; position: relative; flex-grow: 1;" }, [this._svg]);
            this._defaultPitchHeight = 13;
            this._defaultDrumHeight = 40;
            this._backgroundPitchRows = [];
            this._backgroundDrumRow = nerdbox.svgElement("rect");
            this._defaultPinChannels = [
                [nerdbox.makeNotePin(0, 0, 3), nerdbox.makeNotePin(0, 2, 3)],
                [nerdbox.makeNotePin(0, 0, 3), nerdbox.makeNotePin(0, 2, 3)],
                [nerdbox.makeNotePin(0, 0, 3), nerdbox.makeNotePin(0, 2, 3)],
                [nerdbox.makeNotePin(0, 0, 3), nerdbox.makeNotePin(0, 2, 0)],
            ];
            ...
            this.resetCopiedPins = function () {
                ...
                for (var i = 0; i < _this._doc.song.pitchChannelCount; i++) {
                    _this._copiedPinChannels[i] = [nerdbox.makeNotePin(0, 0, 3), nerdbox.makeNotePin(0, maxDivision, 3)];
                }
                for (var i = _this._doc.song.pitchChannelCount; i < _this._doc.song.getChannelCount(); i++) {
                    _this._copiedPinChannels[i] = [nerdbox.makeNotePin(0, 0, 3), nerdbox.makeNotePin(0, maxDivision, 0)];
                }
            };
            this._animatePlayhead = function (timestamp) {
                ...
                if (_this._doc.synth.playing && _this._doc.autoFollow && _this._followPlayheadBar != playheadBar) {
                    new nerdbox.ChangeChannelBar(_this._doc, _this._doc.channel, playheadBar);
            ...
            this._whenCursorReleased = function (event) {
                ...
                if (_this._mouseDragging && continuousChange) {
                    ...
                    if (_this._cursor.curNote == null) {
                        var note = nerdbox.makeNote(_this._cursor.pitch, _this._cursor.start, _this._cursor.end, 3, _this._doc.song.getChannelIsDrum(_this._doc.channel));
                        note.pins = [];
                        for (var _i = 0, _a = _this._cursor.pins; _i < _a.length; _i++) {
                            var oldPin = _a[_i];
                            note.pins.push(nerdbox.makeNotePin(0, oldPin.time, oldPin.volume));
                        }
                        _this._doc.history.record(new nerdbox.ChangeNoteAdded(_this._doc, _this._pattern, note, _this._cursor.curIndex));
                    }
                    else {
                        if (_this._cursor.pitchIndex == -1) {
                            var sequence = new nerdbox.ChangeSequence();
                            if (_this._cursor.curNote.pitches.length == 4) {
                                sequence.append(new nerdbox.ChangePitchAdded(_this._doc, _this._pattern, _this._cursor.curNote, _this._cursor.curNote.pitches[0], 0, true));
                            }
                            sequence.append(new nerdbox.ChangePitchAdded(_this._doc, _this._pattern, _this._cursor.curNote, _this._cursor.pitch, _this._cursor.curNote.pitches.length));
                            _this._doc.history.record(sequence);
                            _this._copyPins(_this._cursor.curNote);
                        }
                        else {
                            if (_this._cursor.curNote.pitches.length == 1) {
                                _this._doc.history.record(new nerdbox.ChangeNoteAdded(_this._doc, _this._pattern, _this._cursor.curNote, _this._cursor.curIndex, true));
                            }
                            else {
                                _this._doc.history.record(new nerdbox.ChangePitchAdded(_this._doc, _this._pattern, _this._cursor.curNote, _this._cursor.pitch, _this._cursor.curNote.pitches.indexOf(_this._cursor.pitch), true));
                            }
                        }
                    }
                }
            ...
            this._documentChanged = function () {
                ...
                _this._pitchCount = _this._doc.song.getChannelIsDrum(_this._doc.channel) ? nerdbox.Config.drumCount : nerdbox.Config.pitchCount;
                ...
                for (var j = 0; j < 12; j++) {
                    _this._backgroundPitchRows[j].style.visibility = nerdbox.Config.scaleFlags[_this._doc.song.scale][j] ? "visible" : "hidden";
                }
                if (_this._doc.song.getChannelIsDrum(_this._doc.channel)) {
                    if (!_this._renderedDrums) {
                        ...
                        _this._svgBackground.setAttribute("height", "" + (_this._defaultDrumHeight * nerdbox.Config.drumCount));
                    }
                }
                else {
                    if (_this._renderedDrums) {
                    ...
                    for (var channel = _this._doc.song.getChannelCount() - 1; channel >= 0; channel--) {
                        ...
                        for (var _i = 0, _a = pattern2.notes; _i < _a.length; _i++) {
                            ...
                            for (var _b = 0, _c = note.pitches; _b < _c.length; _b++) {
                                var pitch = _c[_b];
                                var notePath = nerdbox.svgElement("path");
                ...
                if (_this._pattern != null) {
                    for (var _d = 0, _e = _this._pattern.notes; _d < _e.length; _d++) {
                        ...
                        for (var _f = 0, _g = note.pitches; _f < _g.length; _f++) {
                            ...
                            _this._svgNoteContainer.appendChild(notePath);
                            notePath = nerdbox.svgElement("path");
            ...
            for (var i = 0; i < 12; i++) {
                var y = (12 - i) % 12;
                var rectangle = nerdbox.svgElement("rect");
        ...
        PatternEditor.prototype._updateCursorStatus = function () {
            ...
            if (this._cursor.curNote != null) {
                ...
                mousePitch -= interval;
                this._cursor.pitch = this._snapToPitch(mousePitch, -minInterval, (this._doc.song.getChannelIsDrum(this._doc.channel) ? nerdbox.Config.drumCount - 1 : nerdbox.Config.maxPitch) - maxInterval);
                ...
                this._cursor.pitch = this._snapToPitch(mousePitch, 0, nerdbox.Config.maxPitch);
                ...
                if (this._cursor.end - this._cursor.start == defaultLength) {
                    ...
                    for (var _d = 0, _e = this._copiedPins; _d < _e.length; _d++) {
                        ...
                        if (oldPin.time <= this._cursor.end - this._cursor.start) {
                            this._cursor.pins.push(nerdbox.makeNotePin(0, oldPin.time, oldPin.volume));
                            if (oldPin.time == this._cursor.end - this._cursor.start)
                                break;
                        }
                        else {
                            this._cursor.pins.push(nerdbox.makeNotePin(0, this._cursor.end - this._cursor.start, oldPin.volume));
                            break;
                        }
                    }
                }
        ...
        PatternEditor.prototype._snapToPitch = function (guess, min, max) {
            ...
            if (guess > max)
                guess = max;
            var scale = nerdbox.Config.scaleFlags[this._doc.song.scale];
        ...
        PatternEditor.prototype._copyPins = function (note) {
            ...
            for (var _i = 0, _a = note.pins; _i < _a.length; _i++) {
                var oldPin = _a[_i];
                this._copiedPins.push(nerdbox.makeNotePin(0, oldPin.time, oldPin.volume));
            }
        ...
        PatternEditor.prototype._whenCursorPressed = function () {
            ...
            this._updateCursorStatus();
            this._updatePreview();
            this._dragChange = new nerdbox.ChangeSequence();
            ...
            if (this._mouseDown && this._cursor.valid && continuousChange) {
                ...
                if (this._mouseDragging) {
                    ...
                    if (this._cursor.curNote == null) {
                        ...
                        sequence.append(new nerdbox.ChangeNoteTruncate(this._doc, this._pattern, start, end));
                        var i = void 0;
                        for (i = 0; i < this._pattern.notes.length; i++) {
                            if (this._pattern.notes[i].start >= end)
                                break;
                        }
                        var theNote = nerdbox.makeNote(this._cursor.pitch, start, end, 3, this._doc.song.getChannelIsDrum(this._doc.channel));
                        sequence.append(new nerdbox.ChangeNoteAdded(this._doc, this._pattern, theNote, i));
                        ...
                        if (shiftedTime <= this._cursor.curNote.start && this._cursor.nearPinIndex == this._cursor.curNote.pins.length - 1 ||
                            ...
                            sequence.append(new nerdbox.ChangeNoteAdded(this._doc, this._pattern, this._cursor.curNote, this._cursor.curIndex, true));
                            this._dragVisible = false;
                        }
                        else {
                            ...
                            this._dragVisible = true;
                            sequence.append(new nerdbox.ChangeNoteTruncate(this._doc, this._pattern, start, end, this._cursor.curNote));
                            sequence.append(new nerdbox.ChangePinTime(this._doc, this._cursor.curNote, this._cursor.nearPinIndex, shiftedTime));
                        ...
                        for (var i = 1; i < this._cursor.curNote.pins.length; i++) {
                            ...
                            if (bendVolume > 3)
                                bendVolume = 3;
                            bendInterval = this._snapToPitch(prevPin.interval * (1.0 - volumeRatio) + nextPin.interval * volumeRatio + this._cursor.curNote.pitches[0], 0, nerdbox.Config.maxPitch) - this._cursor.curNote.pitches[0];
                            break;
                        }
                        ...
                        this._dragVisible = true;
                        sequence.append(new nerdbox.ChangeVolumeBend(this._doc, this._cursor.curNote, bendPart, bendVolume, bendInterval));
                        this._copyPins(this._cursor.curNote);
                    }
                    else {
                        this._dragVolume = this._cursor.curNote.pins[this._cursor.nearPinIndex].volume;
                        ...
                        if (bendEnd > this._cursor.curNote.end) {
                            sequence.append(new nerdbox.ChangeNoteTruncate(this._doc, this._pattern, this._cursor.curNote.start, bendEnd, this._cursor.curNote));
                        }
                        if (bendEnd < this._cursor.curNote.start) {
                            sequence.append(new nerdbox.ChangeNoteTruncate(this._doc, this._pattern, bendEnd, this._cursor.curNote.end, this._cursor.curNote));
                        }
                        ...
                        var bendTo = this._snapToPitch(this._findMousePitch(this._mouseY), -minPitch, nerdbox.Config.maxPitch - maxPitch);
                        sequence.append(new nerdbox.ChangePitchBend(this._doc, this._cursor.curNote, bendStart, bendEnd, bendTo, this._cursor.pitchIndex));
                        this._copyPins(this._cursor.curNote);
    ...
    nerdbox.PatternEditor = PatternEditor;
})(nerdbox || (nerdbox = {}));
var nerdbox;
(function (nerdbox) {
    var Box = (function () {
        function Box(channel, x, y, color) {
            this._text = nerdbox.html.text("1");
            this._label = nerdbox.svgElement("text", { x: 16, y: 23, "font-family": "sans-serif", "font-size": 20, "text-anchor": "middle", "font-weight": "bold", fill: "red" }, [this._text]);
            this._rect = nerdbox.svgElement("rect", { width: 30, height: 30, x: 1, y: 1 });
            this.container = nerdbox.svgElement("svg", undefined, [this._rect, this._label]);
    ...
    var TrackEditor = (function () {
        function TrackEditor(_doc, _songEditor) {
            ...
            this._barWidth = 32;
            this._svg = nerdbox.svgElement("svg", { style: "background-color: #000000; position: absolute;", height: 128 });
            this._select = nerdbox.html.select({ className: "trackSelectBox", style: "width: 32px; height: 32px; background: none; border: none; appearance: none; color: transparent; position: absolute;" });
            this.container = nerdbox.html.div({ style: "height: 128px; position: relative; overflow:hidden;" }, [this._svg, this._select]);
            this._boxContainer = nerdbox.svgElement("g");
            this._playhead = nerdbox.svgElement("rect", { fill: "white", x: 0, y: 0, width: 4, height: 128 });
            this._boxHighlight = nerdbox.svgElement("rect", { fill: "none", stroke: "white", "stroke-width": 2, "pointer-events": "none", x: 1, y: 1, width: 30, height: 30 });
            this._upHighlight = nerdbox.svgElement("path", { fill: "black", stroke: "black", "stroke-width": 1, "pointer-events": "none" });
            this._downHighlight = nerdbox.svgElement("path", { fill: "black", stroke: "black", "stroke-width": 1, "pointer-events": "none" });
            this._grid = [];
            this._mouseX = 0;
            this._mouseY = 0;
            this._pattern = null;
            ...
            this._whenMousePressed = function (event) {
                ...
                if (_this._doc.channel == channel && _this._doc.bar == bar) {
                    ...
                    _this._setPattern((_this._doc.song.channelBars[channel][bar] + (up ? 1 : patternCount)) % (patternCount + 1));
                }
                else {
        ...
        TrackEditor.prototype._setChannelBar = function (channel, bar) {
            new nerdbox.ChangeChannelBar(this._doc, channel, bar);
            this._digits = "";
        ...
        TrackEditor.prototype._setPattern = function (pattern) {
            ...
            var continuousChange = this._doc.history.lastChangeWas(this._changePattern);
            var oldValue = continuousChange ? this._changePattern.oldValue : currentValue;
            if (pattern != currentValue) {
                this._changePattern = new nerdbox.ChangePattern(this._doc, oldValue, pattern);
        ...
        TrackEditor.prototype._updatePreview = function () {
            ...
            for (var i = this._renderedPatternCount; i < patternCount; i++) {
                this._select.appendChild(nerdbox.html.option(i, i, false, false));
            }
            ...
            var selectedPattern = this._doc.song.channelBars[this._doc.channel][this._doc.bar];
    ...
    nerdbox.TrackEditor = TrackEditor;
})(nerdbox || (nerdbox = {}));
var nerdbox;
(function (nerdbox) {
    var LoopEditor = (function () {
        function LoopEditor(_doc) {
            ...
            this._endMode = 1;
            this._bothMode = 2;
            this._loop = nerdbox.svgElement("path", { fill: "none", stroke: "#7744ff", "stroke-width": 4 });
            this._highlight = nerdbox.svgElement("path", { fill: "white", "pointer-events": "none" });
            this._svg = nerdbox.svgElement("svg", { style: "background-color: #000000; touch-action: pan-y; position: absolute;", height: this._editorHeight }, [
                this._loop,
                this._highlight,
            ]);
            this.container = nerdbox.html.div({ style: "height: 20px; position: relative; margin: 5px 0;" }, [this._svg]);
            this._change = null;
        ...
        LoopEditor.prototype._whenCursorMoved = function () {
            if (this._mouseDown) {
                ...
                if (this._cursor.mode == this._startMode) {
                    ...
                    this._change = new nerdbox.ChangeLoop(this._doc, oldStart, oldEnd - oldStart, start, end - start);
                }
                    ...
                    this._change = new nerdbox.ChangeLoop(this._doc, oldStart, oldEnd - oldStart, endPoints.start, endPoints.length);
                }
...
(function (nerdbox) {
    var BarScrollBar = (function () {
        function BarScrollBar(_doc, _trackContainer) {
            ...
            this._editorHeight = 20;
            this._notches = nerdbox.svgElement("svg", { "pointer-events": "none" });
            this._handle = nerdbox.svgElement("rect", { fill: "#444444", x: 0, y: 2, width: 10, height: this._editorHeight - 4 });
            this._handleHighlight = nerdbox.svgElement("rect", { fill: "none", stroke: "white", "stroke-width": 2, "pointer-events": "none", x: 0, y: 1, width: 10, height: this._editorHeight - 2 });
            this._leftHighlight = nerdbox.svgElement("path", { fill: "white", "pointer-events": "none" });
            this._rightHighlight = nerdbox.svgElement("path", { fill: "white", "pointer-events": "none" });
            this._svg = nerdbox.svgElement("svg", { style: "background-color: #000000; touch-action: pan-y; position: absolute;", width: this._editorWidth, height: this._editorHeight }, [
                this._notches,
                this._handle,
            ...
            this.container = nerdbox.html.div({ className: "barScrollBar", style: "width: 512px; height: 20px; overflow: hidden; position: relative;" }, [this._svg]);
            this._mouseX = 0;
            this._mouseY = 0;
            this._mouseDown = false;
            this._mouseOver = false;
        ...
        BarScrollBar.prototype.render = function () {
            ...
            if (resized) {
                ...
                for (var i = 0; i <= this._doc.song.barCount; i++) {
                    ...
                    this._notches.appendChild(nerdbox.svgElement("rect", { fill: "#444444", x: i * this._barWidth - 1, y: lineHeight, width: 2, height: this._editorHeight - lineHeight * 2 }));
                }
            }
    ...
    nerdbox.BarScrollBar = BarScrollBar;
})(nerdbox || (nerdbox = {}));
var nerdbox;
(function (nerdbox) {
    var OctaveScrollBar = (function () {
        function OctaveScrollBar(_doc) {
            ...
            this._handle = nerdbox.svgElement("rect", { fill: "#444444", x: 2, y: 0, width: this._editorWidth - 4, height: this._barHeight });
            this._handleHighlight = nerdbox.svgElement("rect", { fill: "none", stroke: "white", "stroke-width": 2, "pointer-events": "none", x: 1, y: 0, width: this._editorWidth - 2, height: this._barHeight });
            this._upHighlight = nerdbox.svgElement("path", { fill: "white", "pointer-events": "none" });
            this._downHighlight = nerdbox.svgElement("path", { fill: "white", "pointer-events": "none" });
            this._svg = nerdbox.svgElement("svg", { style: "background-color: #000000; touch-action: pan-x; position: absolute;", width: this._editorWidth, height: "100%", viewBox: "0 0 20 481", preserveAspectRatio: "none" });
            this.container = nerdbox.html.div({ id: "octaveScrollBarContainer", style: "width: 20px; height: 100%; overflow: hidden; position: relative; flex-shrink: 0;" }, [this._svg]);
            this._mouseX = 0;
            this._mouseY = 0;
            this._mouseDown = false;
            this._mouseOver = false;
            ...
            this._whenCursorReleased = function (event) {
                if (!_this._doc.song.getChannelIsDrum(_this._doc.channel) && !_this._dragging && _this._mouseDown) {
                    ...
                    if (_this._mouseY < _this._barBottom - _this._barHeight * 0.5) {
                        if (currentOctave < 4) {
                            _this._change = new nerdbox.ChangeOctave(_this._doc, oldValue, currentOctave + 1);
            ...
            for (var i = 0; i <= this._octaveCount; i++) {
                this._svg.appendChild(nerdbox.svgElement("rect", { fill: "#886644", x: 0, y: i * this._octaveHeight, width: this._editorWidth, height: this._notchHeight }));
            }
        ...
        OctaveScrollBar.prototype._whenCursorMoved = function () {
            ...
            if (this._dragging) {
                ...
                if (octave != currentOctave) {
                    this._change = new nerdbox.ChangeOctave(this._doc, oldValue, octave);
    ...
    nerdbox.OctaveScrollBar = OctaveScrollBar;
})(nerdbox || (nerdbox = {}));
var nerdbox;
(function (nerdbox) {
    var loadedCount = 0;
    ...
    var Piano = (function () {
        function Piano(_doc) {
            var _this = this;
            this._doc = _doc;
            this._canvas = nerdbox.html.canvas({ width: "32", height: "481", style: "width: 100%; height: 100%;" });
            this._preview = nerdbox.html.canvas({ width: "32", height: "40" });
            this.container = nerdbox.html.div({ style: "width: 32px; height: 100%; overflow:hidden; position: relative; flex-shrink: 0; touch-action: none;" }, [
                this._canvas,
                this._preview,
            ]);
            ...
            this._documentChanged = function () {
                ...
                _this._pitchCount = isDrum ? nerdbox.Config.drumCount : nerdbox.Config.pitchCount;
                _this._updateCursorPitch();
                _this._doc.synth.pianoPitch = _this._cursorPitch + _this._doc.song.channelOctaves[_this._doc.channel] * 12;
            ...
            this._render = function () {
                ...
                for (var j = 0; j < _this._pitchCount; j++) {
                    var pitchNameIndex = (j + nerdbox.Config.keyTransposes[_this._doc.song.key]) % 12;
                    if (isDrum) {
                        key = Drum;
                    ...
                    else if (!nerdbox.Config.scaleFlags[_this._doc.song.scale][j % 12]) {
                        key = nerdbox.Config.pianoScaleFlags[pitchNameIndex] ? WhiteKeyDisabled : BlackKeyDisabled;
                        _this._graphics.drawImage(key, 0, _this._pitchHeight * (_this._pitchCount - j - 1));
                    }
                    else {
                        var text = nerdbox.Config.pitchNames[pitchNameIndex];
                        if (text == null) {
                            var shiftDir = nerdbox.Config.blackKeyNameParents[j % 12];
                            text = nerdbox.Config.pitchNames[(pitchNameIndex + 12 + shiftDir) % 12];
                            if (shiftDir == 1) {
                                text += "♭";
                            }
                            else if (shiftDir == -1) {
                        ...
                        var textColor = nerdbox.Config.pianoScaleFlags[pitchNameIndex] ? "#000000" : "#ffffff";
                        key = nerdbox.Config.pianoScaleFlags[pitchNameIndex] ? WhiteKey : BlackKey;
                        _this._graphics.drawImage(key, 0, _this._pitchHeight * (_this._pitchCount - j - 1));
...
var nerdbox;
(function (nerdbox) {
    var button = nerdbox.html.button, div = nerdbox.html.div, span = nerdbox.html.span, input = nerdbox.html.input, br = nerdbox.html.br, text = nerdbox.html.text;
    var SongDurationPrompt = (function () {
        function SongDurationPrompt(_doc, _songEditor) {
            ...
            this._saveChanges = function () {
                var group = new nerdbox.ChangeGroup();
                group.append(new nerdbox.ChangeBeatsPerBar(_this._doc, SongDurationPrompt._validate(_this._beatsStepper)));
                group.append(new nerdbox.ChangeBarCount(_this._doc, SongDurationPrompt._validate(_this._barsStepper)));
                group.append(new nerdbox.ChangePatternsPerChannel(_this._doc, SongDurationPrompt._validate(_this._patternsStepper)));
                group.append(new nerdbox.ChangeInstrumentsPerChannel(_this._doc, SongDurationPrompt._validate(_this._instrumentsStepper)));
                group.append(new nerdbox.ChangeChannelCount(_this._doc, SongDurationPrompt._validate(_this._pitchChannelStepper), SongDurationPrompt._validate(_this._drumChannelStepper)));
                _this._doc.prompt = null;
                _this._doc.history.record(group, true);
            };
            this._beatsStepper.value = this._doc.song.beatsPerBar + "";
            this._beatsStepper.min = nerdbox.Config.beatsPerBarMin + "";
            this._beatsStepper.max = nerdbox.Config.beatsPerBarMax + "";
            this._barsStepper.value = this._doc.song.barCount + "";
            this._barsStepper.min = nerdbox.Config.barCountMin + "";
            this._barsStepper.max = nerdbox.Config.barCountMax + "";
            this._patternsStepper.value = this._doc.song.patternsPerChannel + "";
            this._patternsStepper.min = nerdbox.Config.patternsPerChannelMin + "";
            this._patternsStepper.max = nerdbox.Config.patternsPerChannelMax + "";
            this._instrumentsStepper.value = this._doc.song.instrumentsPerChannel + "";
            this._instrumentsStepper.min = nerdbox.Config.instrumentsPerChannelMin + "";
            this._instrumentsStepper.max = nerdbox.Config.instrumentsPerChannelMax + "";
            this._pitchChannelStepper.value = this._doc.song.pitchChannelCount + "";
            this._pitchChannelStepper.min = nerdbox.Config.pitchChannelCountMin + "";
            this._pitchChannelStepper.max = nerdbox.Config.pitchChannelCountMax + "";
            this._drumChannelStepper.value = this._doc.song.drumChannelCount + "";
            this._drumChannelStepper.min = nerdbox.Config.drumChannelCountMin + "";
            this._drumChannelStepper.max = nerdbox.Config.drumChannelCountMax + "";
    ...
    nerdbox.SongDurationPrompt = SongDurationPrompt;
})(nerdbox || (nerdbox = {}));
var nerdbox;
(function (nerdbox) {
    var button = nerdbox.html.button, div = nerdbox.html.div, input = nerdbox.html.input, text = nerdbox.html.text;
    ...
    var ExportPrompt = (function () {
        function ExportPrompt(_doc, _songEditor) {
            ...
            this._whenExportToWav = function () {
                var synth = new nerdbox.Synth(_this._doc.song);
            ...
            this._whenExportToMidi = function () {
                ...
                var _loop_1 = function (track) {
                    ...
                    if (isMeta) {
                        writeEventTime(0);
                        writeUint16(0xFF01);
                        writeAscii("http://www.nerdbox.co/#" + song.toBase64String());
                        writeEventTime(0);
                        ...
                        var channelName = song.getChannelIsDrum(channel) ? nerdbox.Config.midiDrumChannelNames[channel - song.pitchChannelCount] : nerdbox.Config.midiPitchChannelNames[channel];
                        if (isChorus)
                            channelName += " chorus";
                        writeEventTime(0);
                        writeUint16(0xFF03);
                        ...
                        var channelRoot = isDrums ? 33 : nerdbox.Config.keyTransposes[song.key];
                        var intervalScale = isDrums ? nerdbox.Config.drumInterval : 1;
                        for (var _i = 0, unrolledBars_1 = unrolledBars; _i < unrolledBars_1.length; _i++) {
                            ...
                            if (pattern != null) {
                                ...
                                if (prevInstrument != nextInstrument) {
                                    ...
                                    writeUint16(0xFF04);
                                    if (isDrums) {
                                        var description = "noise: " + nerdbox.Config.drumNames[song.instrumentWaves[channel][nextInstrument]];
                                        description += ", volume: " + nerdbox.Config.volumeNames[song.instrumentVolumes[channel][nextInstrument]];
                                        description += ", envelope: " + nerdbox.Config.envelopeNames[song.instrumentEnvelopes[channel][nextInstrument]];
                                        ...
                                        var description = "wave: " + nerdbox.Config.waveNames[song.instrumentWaves[channel][nextInstrument]];
                                        description += ", volume: " + nerdbox.Config.volumeNames[song.instrumentVolumes[channel][nextInstrument]];
                                        description += ", envelope: " + nerdbox.Config.envelopeNames[song.instrumentEnvelopes[channel][nextInstrument]];
                                        description += ", filter: " + nerdbox.Config.filterNames[song.instrumentFilters[channel][nextInstrument]];
                                        description += ", chorus: " + nerdbox.Config.chorusNames[song.instrumentChorus[channel][nextInstrument]];
                                        description += ", effect: " + nerdbox.Config.effectNames[song.instrumentEffects[channel][nextInstrument]];
                                        writeAscii(description);
                                        var filterInstruments = nerdbox.Config.filterDecays[song.instrumentFilters[channel][nextInstrument]] == 0 ? nerdbox.Config.midiSustainInstruments : nerdbox.Config.midiDecayInstruments;
                                        writeEventTime(barStartTime);
                                        writeUint8(0xC0 | midiChannel);
                                ...
                                var effectVibrato = nerdbox.Config.effectVibratos[effectChoice];
                                var effectTremolo = nerdbox.Config.effectTremolos[effectChoice];
                                var effectDuration = 0.14;
                                var chorusOffset = nerdbox.Config.chorusIntervals[song.instrumentChorus[channel][nextInstrument]];
                                if (!isChorus)
                                    chorusOffset *= -1;
                                chorusOffset += nerdbox.Config.chorusOffsets[song.instrumentChorus[channel][nextInstrument]];
                                for (var noteIndex = 0; noteIndex < pattern.notes.length; noteIndex++) {
                                    ...
                                    for (var pinIndex = 1; pinIndex < note.pins.length; pinIndex++) {
                                        ...
                                        for (var tick = 0; tick < length_1; tick++) {
                                            ...
                                            var chorusHarmonizes = nerdbox.Config.chorusHarmonizes[song.instrumentChorus[channel][nextInstrument]];
    ...
    nerdbox.ExportPrompt = ExportPrompt;
})(nerdbox || (nerdbox = {}));
var nerdbox;
(function (nerdbox) {
    var button = nerdbox.html.button, div = nerdbox.html.div, input = nerdbox.html.input, text = nerdbox.html.text;
        ...
        function ImportPrompt(_doc, _songEditor) {
            ...
            this._whenFileSelected = function () {
                ...
                reader.addEventListener("load", function (event) {
                    _this._doc.prompt = null;
                    _this._doc.history.record(new nerdbox.ChangeSong(_this._doc, reader.result), true);
                });
    ...
    nerdbox.ImportPrompt = ImportPrompt;
})(nerdbox || (nerdbox = {}));
var nerdbox;
(function (nerdbox) {
    var button = nerdbox.html.button, div = nerdbox.html.div, span = nerdbox.html.span, select = nerdbox.html.select, option = nerdbox.html.option, input = nerdbox.html.input, text = nerdbox.html.text;
    ...
    var SongEditor = (function () {
        function SongEditor(_doc) {
            ...
            this._doc = _doc;
            this.prompt = null;
            this._patternEditor = new nerdbox.PatternEditor(this._doc);
            this._trackEditor = new nerdbox.TrackEditor(this._doc, this);
            this._loopEditor = new nerdbox.LoopEditor(this._doc);
            this._trackContainer = div({ className: "trackContainer" }, [
                this._trackEditor.container,
                this._loopEditor.container,
            ]);
            this._barScrollBar = new nerdbox.BarScrollBar(this._doc, this._trackContainer);
            this._octaveScrollBar = new nerdbox.OctaveScrollBar(this._doc);
            this._piano = new nerdbox.Piano(this._doc);
            this._editorBox = div({}, [
            ...
            this._newSongButton = button({ type: "button" }, [
                ...
                nerdbox.svgElement("svg", { style: "flex-shrink: 0; position: absolute; left: 0; top: 50%; margin-top: -1em; pointer-events: none;", width: "2em", height: "2em", viewBox: "-5 -21 26 26" }, [
                    nerdbox.svgElement("path", { d: "M 2 0 L 2 -16 L 10 -16 L 14 -12 L 14 0 z M 3 -1 L 13 -1 L 13 -11 L 9 -11 L 9 -15 L 3 -15 z", fill: "currentColor" }),
                ]),
            ]);
            this._exportButton = button({ type: "button" }, [
                text("Export"),
                nerdbox.svgElement("svg", { style: "flex-shrink: 0; position: absolute; left: 0; top: 50%; margin-top: -1em; pointer-events: none;", width: "2em", height: "2em", viewBox: "-13 -13 26 26" }, [
                    nerdbox.svgElement("path", { d: "M -8 3 L -8 8 L 8 8 L 8 3 L 6 3 L 6 6 L -6 6 L -6 3 z M 0 2 L -4 -2 L -1 -2 L -1 -8 L 1 -8 L 1 -2 L 4 -2 z", fill: "currentColor" }),
                ]),
            ]);
            ...
            this._instrumentDropDownGroup = div({ className: "selectRow", style: "display: none;" }, [span({}, [text("Instrument: ")]), div({ className: "selectContainer" }, [this._instrumentDropDown])]);
            this._instrumentSettingsLabel = div({ style: "margin: 3px 0; text-align: center; color: #999;" }, [text("Instrument Settings")]);
            this._channelVolumeSlider = input({ style: "margin: 0px;", type: "range", min: "-5", max: "0", value: "0", step: "1" });
            this._waveNames = buildOptions(select({}), nerdbox.Config.waveNames);
            this._drumNames = buildOptions(select({}), nerdbox.Config.drumNames);
            this._envelopeDropDown = buildOptions(select({}), nerdbox.Config.envelopeNames);
            this._filterDropDown = buildOptions(select({}), nerdbox.Config.filterNames);
            this._filterDropDownGroup = div({ className: "selectRow" }, [span({}, [text("Filter: ")]), div({ className: "selectContainer" }, [this._filterDropDown])]);
            this._chorusDropDown = buildOptions(select({}), nerdbox.Config.chorusNames);
            this._chorusDropDownGroup = div({ className: "selectRow" }, [span({}, [text("Chorus: ")]), div({ className: "selectContainer" }, [this._chorusDropDown])]);
            this._effectDropDown = buildOptions(select({}), nerdbox.Config.effectNames);
                        ...
                        div({ className: "editor-controls" }, [
                            div({ className: "playback-controls" }, [
                                ...
                                div({ className: "playback-volume-controls" }, [
                                    nerdbox.svgElement("svg", { style: "flex-shrink: 0;", width: "2em", height: "2em", viewBox: "0 0 26 26" }, [
                                        nerdbox.svgElement("path", { d: "M 4 17 L 4 9 L 8 9 L 12 5 L 12 21 L 8 17 z", fill: "#777" }),
                                        nerdbox.svgElement("path", { d: "M 15 11 L 16 10 A 7.2 7.2 0 0 1 16 16 L 15 15 A 5.8 5.8 0 0 0 15 12 z", fill: "#777" }),
                                        nerdbox.svgElement("path", { d: "M 18 8 L 19 7 A 11.5 11.5 0 0 1 19 19 L 18 18 A 10.1 10.1 0 0 0 18 8 z", fill: "#777" }),
                                    ]),
                                    this._volumeSlider,
                                ]),
                            ]),
                            div({ className: "editor-menus" }, [
                                ...
                                div({ className: "selectContainer menu" }, [
                                    this._editMenu,
                                    nerdbox.svgElement("svg", { style: "flex-shrink: 0; position: absolute; left: 0; top: 50%; margin-top: -1em; pointer-events: none;", width: "2em", height: "2em", viewBox: "-5 -21 26 26" }, [
                                        nerdbox.svgElement("path", { d: "M 0 0 L 1 -4 L 4 -1 z M 2 -5 L 10 -13 L 13 -10 L 5 -2 zM 11 -14 L 13 -16 L 14 -16 L 16 -14 L 16 -13 L 14 -11 z", fill: "currentColor" }),
                                    ]),
                                ]),
                                div({ className: "selectContainer menu" }, [
                                    this._optionsMenu,
                                    nerdbox.svgElement("svg", { style: "flex-shrink: 0; position: absolute; left: 0; top: 50%; margin-top: -1em; pointer-events: none;", width: "2em", height: "2em", viewBox: "-13 -13 26 26" }, [
                                        nerdbox.svgElement("path", { d: "M 5.85 -1.34 L 7.85 -1.34 L 7.85 1.34 L 5.85 1.34 L 4.69 3.74 L 5.94 5.3 L 3.85 6.97 L 2.6 5.41 L 0 6 L -0.45 7.95 L -3.05 7.36 L -2.6 5.41 L -4.69 3.74 L -6.49 4.61 L -7.65 2.2 L -5.85 1.34 L -5.85 -1.34 L -7.65 -2.2 L -6.49 -4.61 L -4.69 -3.74 L -2.6 -5.41 L -3.05 -7.36 L -0.45 -7.95 L -0 -6 L 2.6 -5.41 L 3.85 -6.97 L 5.94 -5.3 L 4.69 -3.74 M 2.92 0.67 L 2.92 -0.67 L 2.35 -1.87 L 1.3 -2.7 L 0 -3 L -1.3 -2.7 L -2.35 -1.87 L -2.92 -0.67 L -2.92 0.67 L -2.35 1.87 L -1.3 2.7 L -0 3 L 1.3 2.7 L 2.35 1.87 z", fill: "currentColor" }),
                                    ]),
                                ]),
                                this._exportButton,
                            ]),
            ...
            this.whenUpdated = function () {
                ...
                _this._tempoSlider.title = _this._doc.song.getBeatsPerMinute() + " beats per minute";
                _this._reverbSlider.value = "" + _this._doc.song.reverb;
                setSelectedIndex(_this._partDropDown, nerdbox.Config.partCounts.indexOf(_this._doc.song.partsPerBeat));
                if (_this._doc.song.getChannelIsDrum(_this._doc.channel)) {
                ...
                _this._instrumentDropDownGroup.style.display = (_this._doc.song.instrumentsPerChannel > 1) ? "flex" : "none";
                _this._instrumentDropDownGroup.style.visibility = (pattern != null) ? "visible" : "hidden";
                ...
                switch (event.keyCode) {
                    ...
                    case 219:
                        ...
                        if (_this._doc.autoFollow) {
                            new nerdbox.ChangeChannelBar(_this._doc, _this._doc.channel, Math.floor(_this._doc.synth.playhead));
                        }
                        event.preventDefault();
                        break;
                    case 221:
            ...
            this._whenNewSongPressed = function () {
                _this._doc.history.record(new nerdbox.ChangeSong(_this._doc, ""));
            ...
            this._whenSetScale = function () {
                _this._doc.history.record(new nerdbox.ChangeScale(_this._doc, _this._scaleDropDown.selectedIndex));
            };
            this._whenSetKey = function () {
                _this._doc.history.record(new nerdbox.ChangeKey(_this._doc, _this._keyDropDown.selectedIndex));
            };
            this._whenSetTempo = function () {
                ...
                _this._changeTempo = new nerdbox.ChangeTempo(_this._doc, oldValue, parseInt(_this._tempoSlider.value));
            ...
            this._whenSetReverb = function () {
                ...
                _this._changeReverb = new nerdbox.ChangeReverb(_this._doc, oldValue, parseInt(_this._reverbSlider.value));
                _this._doc.history.record(_this._changeReverb, continuousChange);
            };
            this._whenSetPartsPerBeat = function () {
                _this._doc.history.record(new nerdbox.ChangePartsPerBeat(_this._doc, nerdbox.Config.partCounts[_this._partDropDown.selectedIndex]));
            };
            this._whenSetWave = function () {
                _this._doc.history.record(new nerdbox.ChangeWave(_this._doc, _this._waveNames.selectedIndex));
            };
            this._whenSetDrum = function () {
                _this._doc.history.record(new nerdbox.ChangeWave(_this._doc, _this._drumNames.selectedIndex));
            };
            this._whenSetFilter = function () {
                _this._doc.history.record(new nerdbox.ChangeFilter(_this._doc, _this._filterDropDown.selectedIndex));
            };
            this._whenSetEnvelope = function () {
                _this._doc.history.record(new nerdbox.ChangeEnvelope(_this._doc, _this._envelopeDropDown.selectedIndex));
            };
            this._whenSetEffect = function () {
                _this._doc.history.record(new nerdbox.ChangeEffect(_this._doc, _this._effectDropDown.selectedIndex));
            };
            this._whenSetChorus = function () {
                _this._doc.history.record(new nerdbox.ChangeChorus(_this._doc, _this._chorusDropDown.selectedIndex));
            };
            this._whenSetVolume = function () {
                ...
                _this._changeVolume = new nerdbox.ChangeVolume(_this._doc, oldValue, -parseInt(_this._channelVolumeSlider.value));
            ...
            this._whenSetInstrument = function () {
                ...
                if (pattern == null)
                    return;
                _this._doc.history.record(new nerdbox.ChangePatternInstrument(_this._doc, _this._instrumentDropDown.selectedIndex, pattern));
            };
        ...
        SongEditor.prototype._setPrompt = function (promptName) {
            ...
            if (promptName) {
                switch (promptName) {
                    case "export":
                        this.prompt = new nerdbox.ExportPrompt(this._doc, this);
                        break;
                    case "import":
                        this.prompt = new nerdbox.ImportPrompt(this._doc, this);
                        break;
                    case "duration":
                        this.prompt = new nerdbox.SongDurationPrompt(this._doc, this);
                        break;
                }
                if (this.prompt) {
        ...
        SongEditor.prototype._paste = function () {
            ...
            if (patternCopy != null && patternCopy.drums == this._doc.song.getChannelIsDrum(this._doc.channel)) {
                this._doc.history.record(new nerdbox.ChangePaste(this._doc, pattern, patternCopy.notes, patternCopy.beatsPerBar, patternCopy.partsPerBeat));
            }
        };
        SongEditor.prototype._transpose = function (upward) {
            ...
            this._changeTranspose = new nerdbox.ChangeTranspose(this._doc, pattern, upward);
            this._doc.history.record(this._changeTranspose, continuousChange);
        };
        return SongEditor;
    }());
    nerdbox.SongEditor = SongEditor;
    var doc = new nerdbox.SongDocument(location.hash);
